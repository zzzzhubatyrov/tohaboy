<template>
  ...
  <div class="equipment-container">
    <!-- Header -->
    <div class="header">
      <h1 class="title">Управление оборудованием</h1>
      <div class="header-stats">
        ...
        <div class="stat-item">
          <span class="stat-number">{{ availableEquipment }}</span>
    ...
    <div class="action-panel">
      <div class="action-left">
        ...
        <div class="filter-group">
          <select v-model="filterType" @change="applyFilters" class="select">
          ...
          <form @submit.prevent="saveEquipment">
            <div class="form-grid">
              ...
              <div class="form-group">
                ...
                <input
                    v-model="currentEquipment.category"
                    :disabled="modalMode === 'view'"
                    required
                    class="form-input"
                />
...
export default {
  ...
  computed: {
    categories() {
      return [...new Set(this.equipment.map(eq => eq.category).filter(Boolean))]
    },

    totalEquipment() {
      return this.equipment.reduce((sum, eq) => sum + eq.quantity, 0)
    },
  ...
  methods: {
    ...
    applyFilters() {
      ...
      // Category filter
      if (this.filterType) {
        filtered = filtered.filter(eq => eq.category === this.filterType)
      }
    ...
    async saveEquipment() {
      try {
        ...
        if (!this.currentEquipment.category) {
